...
//
//*****************************************************************************
#define CONSOLE_TASKSTACKSIZE        128         // Stack size in words
...
//
//*****************************************************************************
#define CONSOLE_ITEM_SIZE           sizeof(uint8_t)
#define CONSOLE_QUEUE_SIZE          5
...
ConsoleTaskInit(void)
{
    ...
    return_val = xTaskCreate(
                              ConsoleTask,                            // Function Pointer
                              (signed portCHAR *)"Console",           // Task Name
                              CONSOLE_TASKSTACKSIZE,                  // Stack Depth in Words
